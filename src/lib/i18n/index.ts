...
const resources = {
  es: {
    translation: {
      ...
      annotate: { prev: "Anterior", next: "Siguiente", undo: "Deshacer", clearPage: "Limpiar página", save: "Guardar PDF" },
  ...
  en: {
    translation: {
      ...
      annotate: { prev: "Previous", next: "Next", undo: "Undo", clearPage: "Clear page", save: "Save PDF" },
