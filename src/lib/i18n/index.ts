  ...
  es: {
    translation: {
      ...
      tools: {
        ...
        annotate: { title: "Pintar y subrayar", desc: "Dibuja con boli o subraya sobre cualquier PDF" },
        editText: { title: "Editar texto", desc: "Detecta bloques de texto y edítalos, muévelos o elimínalos" },
      },
      ...
      annotate: { prev: "Anterior", next: "Siguiente", undo: "Deshacer", clearPage: "Limpiar página", save: "Guardar PDF", select: "Seleccionar y mover", draw: "Dibujar" },
      editText: { note: "Detección por bloques: la tipografía original puede no preservarse exactamente. Los bloques editados se redibujan en Helvetica sobre un recuadro blanco." },
  ...
  en: {
    translation: {
      ...
      tools: {
        ...
        annotate: { title: "Draw & highlight", desc: "Pen and highlighter over any PDF" },
        editText: { title: "Edit text", desc: "Detect text blocks and edit, move or delete them" },
      },
      ...
      annotate: { prev: "Previous", next: "Next", undo: "Undo", clearPage: "Clear page", save: "Save PDF", select: "Select & move", draw: "Draw" },
      editText: { note: "Block detection: original typography may not be preserved exactly. Edited blocks are redrawn in Helvetica over a white box." },
